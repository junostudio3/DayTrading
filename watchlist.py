...
class Watchlist:
            ...
            try:
                with open(self.cache_file_path, "r", encoding="utf-8") as f:
                    ...
                    for item in data.get("items", []):
                        ...
                        remaining_time = item.get("remaining_time", TradingParams.WATCHLIST_ITEM_EXPIRY_DAYS * 6.5 * 3600)
                        ...
                        if self.is_avoided(pdno, prdt_name, price, volume):
                            continue
                        self.items.append(WatchlistItem(
    ...
    def update_stock(self, pdno: str, name: str, price: int, volume: int) -> bool:
        ...
        max_count = TradingParams.WATCHLIST_ITEM_MAX_COUNT
        ...
        initial_time = TradingParams.WATCHLIST_ITEM_EXPIRY_DAYS * 6.5 * 3600
        self.items.append(WatchlistItem(
